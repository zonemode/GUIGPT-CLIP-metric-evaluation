...
def load_eva_clip_model():
    ...
    local_weight_path = "C:/Users/king/.cache/huggingface/hub/EVA02_CLIP_B_psz16_s8B/EVA02_CLIP_B_psz16_s8B.pt"  
...
# ====== 加载模型 ======
print("正在加载CLIP模型...")
model, preprocess, device = load_eva_clip_model()
print(f"模型已加载到设备: {device}")
print(f"使用的模型: EVA02-CLIP-B-16")
...
# 保存详细结果到文件
output_file = os.path.join(script_dir, '..', '..', 'Results', 'Eva02','Chinese_cuda_eva_CLIP-I_results_0123.txt')
with open(output_file, 'w', encoding='utf-8') as f:
    f.write("CLIP-I 结果\n")
    f.write("模型: EVA02-CLIP-B-16\n")
    f.write("="*50 + "\n\n")
